...
pub fn generate() -> String {
    ...
    out.push_str("|------|---------|-------------|-------------------|\n");
    out.push_str("| `bft` | `kqs doc new bft \"Title\"` | Business Foundation | Top: business requirements |\n");
    out.push_str("| `brd` | `kqs doc new brd \"Title\"` | Business Requirements Document | Business detail |\n");
    out.push_str("| `frd` | `kqs doc new frd \"Title\"` | Functional Requirements | UX / features |\n");
    out.push_str("| `nfr` | `kqs doc new nfr \"Title\"` | Non-Functional Requirements | Quality attributes |\n");
    out.push_str("| `adr` | `kqs doc new adr \"Title\"` | Architecture Decision Record | Design decisions |\n");
    out.push_str("| `rfc` | `kqs doc new rfc \"Title\"` | Request for Comments | Discussion |\n");
    out.push_str("| `tz`  | `kqs doc new tz \"Title\"` | Technical Design | Implementation spec |\n");
    out.push_str("| `idea` | `kqs doc new idea \"Title\"` | Idea | Brainstorm |\n");
    out.push_str("| `screen` | `kqs screen \"Title\"` | Screen Design | UI mockup desc |\n");
    out.push_str("| `userflow` | `kqs userflow \"Title\"` | User Flow | UX flow |\n\n");
    ...
    out.push_str("kqs doc new tz \"Search API Design\"\n");
    out.push_str("```\n\n");
    ...
    out.push_str("```bash\n");
    out.push_str("kqs typespec new VideoClip\n");
    out.push_str("kqs typespec new SearchQuery\n");
    out.push_str("```\n\n");

    out.push_str("### Step 5: Verify traceability\n\n");
    out.push_str("```bash\n");
    out.push_str("kqs check traceability              # Basic matrix\n");
    out.push_str("kqs check traceability-deep --deep   # Full chain verification\n");
    out.push_str("```\n\n");

    out.push_str("### Step 6: Generate README\n\n");
    out.push_str("```bash\n");
    out.push_str("kqs readme   # Auto-generates Kanban board + Table of Contents\n");
    out.push_str("```\n\n");

    out.push_str("## All Commands\n\n");
    out.push_str("| Command | Description | Doc mode | Dev mode |\n");
    out.push_str("|---------|-------------|----------|----------|\n");
    out.push_str("| `kqs init` | Create knowledge repo | ✅ | ❌ |\n");
    out.push_str("| `kqs doc new <type> \"title\"` | Create document | ✅ | ❌ |\n");
    out.push_str("| `kqs doc list` | List all docs | ✅ | ✅ |\n");
    out.push_str("| `kqs doc template --list` | List doc types | ✅ | ✅ |\n");
    out.push_str("| `kqs screen \"title\"` | Create screen design | ✅ | ❌ |\n");
    out.push_str("| `kqs userflow \"title\"` | Create user flow | ✅ | ❌ |\n");
    out.push_str("| `kqs typespec new <name>` | Create TypeSpec model | ✅ | ❌ |\n");
    out.push_str("| `kqs typespec list` | List models | ✅ | ✅ |\n");
    out.push_str("| `kqs check traceability` | Basic trace report | ✅ | ✅ |\n");
    out.push_str("| `kqs check traceability-deep --deep` | Deep coverage | ✅ | ✅ |\n");
    out.push_str("| `kqs check traceability-deep --json` | JSON report | ✅ | ✅ |\n");
    out.push_str("| `kqs check traceability-deep --chain \"bft adr tz\"` | Custom chain | ✅ | ✅ |\n");
    out.push_str("| `kqs check scan` | Scan projects for @doc-anchor | ✅ | ✅ |\n");
    out.push_str("| `kqs check scan --rebuild` | Rebuild + scan | ✅ | ✅ |\n");
    out.push_str("| `kqs check notify --since 7d` | Stale link notifications | ✅ | ✅ |\n");
    out.push_str("| `kqs check orphans` | Find orphaned models | ✅ | ✅ |\n");
    out.push_str("| `kqs readme` | Regenerate README | ✅ | ❌ |\n");
    out.push_str("| `kqs push` | Push with README gen | ✅ | ❌ |\n");
    out.push_str("| `kqs watch` | Auto-commit file watcher | ✅ | ✅ |\n");
    out.push_str("| `kqs watch --trace` | Watch + trace daemon | ✅ | ✅ |\n");
    out.push_str("| `kqs search \"query\"` | Full-text search | ✅ | ✅ |\n");
    out.push_str("| `kqs task new --title \"...\"` | Create task | ✅ | ✅ |\n");
    out.push_str("| `kqs task list` | List tasks | ✅ | ✅ |\n");
    out.push_str("| `kqs conflict list` | List merge conflicts | ✅ | ✅ |\n");
    out.push_str("| `kqs ask \"question\"` | Ask LLM with context | ✅ | ✅ |\n\n");
    ...
    out.push_str("```\n\n");
    out.push_str("Scan: `kqs check scan`. Orphan anchors without docs auto-create a task.\n\n");
    ...
    out.push_str("6. Use `kqs --doc` flag when working in the knowledge repo.\n");
