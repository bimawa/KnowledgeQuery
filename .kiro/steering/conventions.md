...
<!-- kqs:start -->
## 🎯 Статус
<!-- kqs генерирует: канбан, статистику, ссылки на docs -->
<!-- kqs:end -->
```

- kqs пишет ТОЛЬКО между маркерами `<!-- kqs:start -->` / `<!-- kqs:end -->`
- Ручные правки вне маркеров неприкосновенны
- Если маркеров нет — kqs НЕ трогает README (первый раз вставляет маркеры с пустым блоком)
